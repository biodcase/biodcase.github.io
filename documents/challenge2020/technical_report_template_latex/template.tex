% --------------------------------------------------------------------------
% Template for DCASE 2020 technical reports; to be used with:
%          dcase2020_techrep.sty  - DCASE 2020 LaTeX style file, and
...
% Title.
% --------------------
\title{AUTHOR GUIDELINES FOR DCASE 2020 CHALLENGE TECHNICAL REPORTS}
...
The guidelines given below include complete descriptions of the fonts, spacing, and related information. Please use this template to produce uniformly looking DCASE 2020 Challenge technical reports.
...
You are allowed a total of up to 5 pages for your DCASE 2020 Challenge technical report. The report can also be shorter and does not need to include a literature review. If however you plan to submit the same report as a regular paper to DCASE 2020 Workshop, please structure it as a scientific paper and respect the rules given for the workshop paper formatting. 
...
List and number all bibliographical references at the end of the paper. The references should be numbered in order of appearance in the document. When referring to them in the text, type the corresponding reference number in square brackets as shown at the end of this sentence \cite{cJones2003}, \cite{aSmith2000}. For \LaTeX\ users, the use of the Bib\TeX\ style file IEEEtran.bst is recommended, which is included in the \LaTeX\ paper kit available from the DCASE 2020 website \cite{dcase2020web}.
